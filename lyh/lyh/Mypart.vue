<template>
    <div>
        <div class="absolute"><img src="yimiao.png" alt=""> <div class="num"> 
        ...
        <div class="bottom ">
            <div class="bm1 clearfix">
                <span class="bm1-1"> <strong>最新健康自查</strong> </span>
                <span class="bm1-2"> <strong>无异常</strong> </span> 
            </div>
            <div class="bm2 ">
            <div class="bm2-1"><img src="gps.png" alt=""><span> 行程信息</span><button class="btn-t">核验行程</button></div>
            <h6>14天内未到访到过中高风险地区所在城市</h6>           
            </div>
            <div class="bm3">
                <img src="zhen.png" alt=""> <span>已接种新冠疫苗2剂（共2剂）</span> <a><img class='back' src="向右_返回.png" alt=""></a> 
            </div>
        </div>
    </div>
</template>
